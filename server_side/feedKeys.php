...
define('TL_MOSAIC_ENTRIES','entries');
...
//MOSAIC
define('MOSAIC_ENTRY_URL','meUrl');
define('MOSAIC_ENTRY_ARTICLE_ID','meArticleId');
define('MOSAIC_ENTRY_HEIGHT','meHeight');
define('MOSAIC_ENTRY_WIDTH','meWidth');
